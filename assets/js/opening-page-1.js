...
function showOpeningPage() {
  // Draw the initial game scene as the background
  drawInitialScene();
  ...
  const openingText = [
      ...
      "1-back",
      "Rules:",
      "1. Remember the sequence of mushrooms as they appear.",
      "2. Use arrow keys to move Mario:",
      "   - Right to collect the mushroom",
      "   - Up to jump (avoid mushroom if needed)",
      "3. Collect mushrooms that match the one shown 1 step back in the sequence.",
      "4. Correct matches: +10 points",
      "5. Incorrect matches: -5 points",
      "6. The first mushroom is just for observation, action starts from the second one.",
      "",
